...
class InputWidget extends Component {
    ...
    didClickBody (e) {
      if (this.state.popoverOpen) {
        ...
        while (tmpNode) {
          ...
          if (this._elInput.$V.dom === tmpNode || (tmpNode.className && tmpNode.className.indexOf('InfernoFormlib-DateFieldCalendar') >= 0)) {
    ...
    render () {
        ...
        const inputId = generateId(this.props.namespace, '__Field')
